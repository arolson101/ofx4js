...
ChildAggregate.add({required: true, order: 30, owner: InvestmentStatementRequestTransaction, /*type: InvestmentStatementRequest,*/ readMethod: "getMessage", writeMethod: "setMessage"});
