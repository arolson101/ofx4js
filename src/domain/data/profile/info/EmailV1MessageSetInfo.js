...
Element.add(EmailV1MessageSetInfo, {name: "MAILSUP", required: true, order: 10, attributeType: bool, readMethod: "getSupportsMail", writeMethod: "setSupportsMail"});
...
Element.add(EmailV1MessageSetInfo, {name: "GETMIMESUP", required: true, order: 20, attributeType: bool, readMethod: "getSupportsMimeType", writeMethod: "setSupportsMimeType"});
